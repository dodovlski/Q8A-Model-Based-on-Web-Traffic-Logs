...
dictionary = {'request': ['GET', 'POST', 'PUT', 'DELETE'], 
              'endpoint': ['/usr', '/usr/admin', '/usr/admin/developer', '/usr/login', '/usr/register', 
                           "/index.html","/about.php","/contact/","/products/12345","/blog/latest-news",
                           "/images/banner.jpg","/search?q=keyword","/user/profile/settings",
                           "/download/file.pdf","/api/v1/data"], 
...
for _ in range(1,100):
    f.write('%s - - [%s] "%s %s HTTP/1.0" %s %s "-" "%s" %s\n' % 
        (fak.ipv4(),
        random_date("01/Jan/2020:12:00:00 +0530","01/Jan/2024:12:00:00 +0530"), 
